!(function (e) {
  function n(n) {
    for (var t, o, i = n[0], a = n[1], c = 0, s = []; c < i.length; c++)
      (o = i[c]),
    ...
    function u(e, n) {
      for (var t = {}, r = [], o = 0; o < e.length; o++) {
        ...
        -1 !== f
          ...
          : a.push({ identifier: l, updater: b(d, n), references: 1 }),
          r.push(l);
      }
      return r;
    }
  ...
  function (e, n, t) {
    (n = t(1)(!1)).push([e.i, "body{background:gray}", ""]), (e.exports = n);
  },
  function (e, n, t) {
    var r = t(0),
      o = t(5);
  ...
  function (e, n, t) {
    ...
    t.r(n);
    t(2), t(4), t(6);
    var r = t.p + "8f9327db2597fa57d2f42b4a6c5a9855.png";
    console.log(r), console.log("x: ", "xxxx");
